...
# Phase 12: Recalibrated from 95.00 to 65.00 based on empirical sweep.
# At 95.00, the formula (LLM×Trust×Health) is mathematically unreachable
# because max adjusted confidence is ~64 (confidence × 0.85 trust).
# 65.00 yields 4 trades, 75% WR, PF=4.33, 0.16% DD on calibration data.
EXECUTION_THRESHOLD = Decimal("65.00")
